...
public class AESUtils {
	...
	public static String genKeyString() {
		return new String(Hex.encodeHex(genKey(DEFAULT_AES_KEYSIZE)));
	}
	...
	public static String encode(String input) {
		try {
			return new String(Hex.encodeHex(encode(input.getBytes(DEFAULT_URL_ENCODING), DEFAULT_KEY)));
	...
	public static String encode(String input, String key) {
		try {
			return new String(Hex.encodeHex(encode(input.getBytes(DEFAULT_URL_ENCODING), Hex.decodeHex(key))));
		} catch (UnsupportedEncodingException e) {
			return "";
	...
	public static String decode(String input) {
		try {
			return new String(decode(Hex.decodeHex(input), DEFAULT_KEY), DEFAULT_URL_ENCODING);
		} catch (UnsupportedEncodingException e) {
			return "";
		} catch (DecoderException e) {
            e.printStackTrace();
	...
	public static String decode(String input, String key) {
		try {
			return new String(decode(Hex.decodeHex(input), Hex.decodeHex(key)), DEFAULT_URL_ENCODING);
		} catch (UnsupportedEncodingException e) {
			return "";
		} catch (DecoderException e) {
            e.printStackTrace();
	...
	public static void main(String[] args) {
		...
		String ss = encode(s, key);
		System.out.println(ss);
		String sss = decode(ss, key);
